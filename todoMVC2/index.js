    ...
    render(){
        ...
        return (
            <div>
                ...
                />
                <button style={{backgroundColor: this.state.type === "all"? "red": "#ccc" }} onClick={(e)=>{this.showType("all")}}>all</button>
                <button style={{backgroundColor: this.state.type === "active"? "red": "#ccc" }} onClick={(e)=>{this.showType("active")}}>active</button>
                <button style={{backgroundColor: this.state.type === "completed"? "red": "#ccc" }} onClick={(e)=>{this.showType("completed")}}>completed</button>
            </div>
        )
    },
    showType(str){
